...
Route::middleware(['verified', 'auth'])->group(function(){
    ...
    //Route::post('/post/{post}/comments', [CommentController::class, 'create'])->name('post.comment');
});

Route::middleware(['verified', 'auth'])->group(function(){
    Route::resource('posts', PostController::class);
    Route::post('/post/{post}/comments', [CommentController::class, 'store'])->name('post.comment');
